...
<body>
    ...
    <?php
    require "connect.php";
    $sql = "SELECT * FROM tb_section WHERE SECT_TELEPHONE LIKE '%12%' ORDER BY SECT_NAME DESC";// Replace with your table name
    $stmt = $pdo->query($sql);
    ...
    <div class="container mt-3">
        ...
        <div class="btn-group btn-group-lg">
            ...
            <button type="button" class="btn btn-secondary"onclick="window.location.href ='lesson1.php'">Lesson 2 :>Lesson 2 : แสดงข้อมูลเฉพาะ SECT_TELEPHONE และ SECT_NAME โดยเรียงจาก SECT_NAME จาก A-Z
</button>
